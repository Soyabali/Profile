...
class _MyHomePageState extends State<MyHomePage> {
            ...
            children: <Widget>[
              ...
              Positioned(
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      Text('Chris Pratt', style: TextStyle(
                        fontFamily: 'Comfortaa',
                        fontWeight: FontWeight.bold,
                        fontSize: 17.0
                      ),),
                      SizedBox(height: 10.0),
                      Text('China', style: TextStyle(
                          fontFamily: 'Comfortaa',
                          fontWeight: FontWeight.bold,
                          fontSize: 17.0,
                        color: Colors.grey
  ...
  Widget menuCard(String title,String imgPath,
      String type,int rating,double views,double likes){
    return Padding(
